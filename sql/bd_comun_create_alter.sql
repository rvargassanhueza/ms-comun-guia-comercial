...
CREATE TABLE T_SUB_CATEGORIA(
	...
	nombre_sub_categoria 	varchar(100) null,
	destacado_sub_categoria bit(0),
	fecha_creacion 			date null,
  	fecha_modificacion 		date null,
  	usuario_creacion 		int null,
  	usuario_modificacion 	int null,
...
ALTER TABLE T_CATEGORIA    ADD  CONSTRAINT FK_T_CATEGORIA_LOCALIDAD FOREIGN KEY(id_localidad)
REFERENCES T_LOCALIDAD (id_localidad);

ALTER TABLE T_SUB_CATEGORIA    ADD  CONSTRAINT FK_T_SUB_CATEGORIA_CATEGORIA FOREIGN KEY(id_categoria)
REFERENCES T_CATEGORIA (id_categoria);

ALTER TABLE T_PASO_CATEGORIA_SUB_CATEGORIA    ADD  CONSTRAINT FK_T_CATEGORIA_SUB_CATEGORIA FOREIGN KEY(id_sub_categoria)
REFERENCES T_SUB_CATEGORIA (id_sub_categoria);

ALTER TABLE T_PASO_LOCALIDAD_CATEGORIA    ADD  CONSTRAINT FK_T_REGISTRO_LOCALIDAD_CATEGORIAS FOREIGN KEY(id_categoria)
REFERENCES T_CATEGORIA (id_categoria);